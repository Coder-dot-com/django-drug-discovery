...
def generate_molecule(generation_request):
    ...
    num_epochs = 2  #can change this based on user input
...
model_file = "TL_reinvent.model.2.chkpt" #  trained model after transfer learning can change 20 to user based input
